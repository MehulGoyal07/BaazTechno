...
const CreatePost = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // 1. Upload the image to your storage (e.g., Firebase, AWS S3)
      // 2. Get the image URL
      // 3. Send all data to your backend API
      ...
      editor.commands.setContent('<p>Start writing your post content here...</p>');
    } catch (err) {
